								...
								<div class="d-flex align-items-center">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb  mb-0">
											<li class="breadcrumb-item"><a href="{{route('salesmanagers')}}">Sales Profile</a></li>
										...
										<div class="contact-info w-xxl-30 w-100">
											...
											<div class="text-center mt-5">
												<div class="dropify-circle edit-img">
													<input type="file" id='saleprofileimg' name="profileimg" class="dropify-1" data-default-file={{asset("dist/img/avatar2.jpg")}} />
												</div>

<nav class="contactapp-sidebar">
    <div data-simplebar class="nicescroll-bar">
        <div class="menu-content-wrap">
            <button type="button" class="btn btn-primary btn-rounded btn-block mb-4" data-bs-toggle="modal" data-bs-target="#create_new_Order">
                Create New Order
            </button>
                ...
                <ul class="nav nav-light navbar-nav flex-column">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="{{route('Archivesalesprofile')}}">
                            ...
                            <span class="nav-link-text">Compalte Orders</span>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{route('Archivesalesprofile')}}">
                            <span class="nav-icon-wrap"><span class="feather-icon"><i data-feather="archive"></i></span></span>
                            <span class="nav-link-text">Cancel Orders</span>
                        </a>
                    </li>
                </ul>
            </div>

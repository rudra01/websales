							...
							<header class="contact-header">
								<div class="d-flex align-items-center">
									...
									<div class="dropdown ms-3">
										{{-- <button class="btn btn-sm btn-outline-secondary flex-shrink-0  d-lg-inline-block d-none" data-bs-toggle="modal" data-bs-target="#add_new_salesman" >Create New</button> --}}
									</div>
								</div>
                                                    ...
                                                    @if($sale->profile->Status == 'Active')
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="media align-items-center">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <span class="d-block text-high-em">{{$sale->vendor->Company_Name}}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="text-truncate">{{$sale->name}}</td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="d-flex">
                                                                        <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="/Vendor/{{$sale->id}}"><span class="icon"><span class="feather-icon"><i data-feather="edit"></i></span></span></a>
                                                                    </div>

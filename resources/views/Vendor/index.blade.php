							...
							<header class="contact-header">
								<div class="d-flex align-items-center">
									...
									<div class="dropdown ms-3">
										<button class="btn btn-sm btn-outline-secondary flex-shrink-0  d-lg-inline-block d-none" data-bs-toggle="modal" data-bs-target="#add_new_Vendor" >Create New</button>
									</div>
								</div>
											...
											<tbody>
                                                ...
                                                <tr>
													...
													<td>
														<div class="media align-items-center">
															...
															<div class="media-body">
																<span class="d-block text-high-em">{{$vendor->vendor->Company_Name}}</span>
															</div>
														</div>
													</td>
													<td class="text-truncate">{{$vendor->name}}</td>
													<td class="text-truncate">{{$vendor->email}}</td>
													<td>{{$vendor->profile->Phone ?? 'Phone no' }}</td>
													<td>

                                                        <span class="badge badge-soft-violet my-1  me-2">{{$vendor->profile->Status ?? 'No Status' }}</span>
													...
													<td>
														<div class="d-flex align-items-center">
															<div class="d-flex">
																<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="/Vendor/{{$vendor->id}}"><span class="icon"><span class="feather-icon"><i data-feather="edit"></i></span></span></a>
															</div>
